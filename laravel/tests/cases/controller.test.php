...
class ControllerTest extends PHPUnit_Framework_TestCase {
	...
	public function testTemplateControllersReturnTheTemplate()
	{
		...
		$home = file_get_contents(path('app').'views/dmw/index.php');
	...
	{
		IoC::register('controller: dmw', function()
		{
			require_once path('app').'controllers/dmw.php';
		...
		$controller = Controller::resolve(DEFAULT_BUNDLE, 'dmw');
