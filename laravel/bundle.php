...
class Bundle {
	 ...
	 *		$bundle = Bundle::name('admin::dmw.index');
	 * </code>
	 *
	 ...
	 *
	 * <code>
	 *		// Returns "dmw.index" as the element name for the identifier
	 *		$bundle = Bundle::bundle('admin::dmw.index');
	 * </code>
	 *
	 * @param  string  $identifier
	 * @return string
	 ...
	 *
	 * <code>
	 *		// Returns "admin::dmw.index"
	 *		$identifier = Bundle::identifier('admin', 'dmw.index');
	 *
	 *		// Returns "dmw.index"
	 *		$identifier = Bundle::identifier('application', 'dmw.index');
	 * </code>
	 *
	 * @param  string  $bundle
