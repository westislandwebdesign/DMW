...
class Filter_Collection {
	 ...
	 *
	 *		// Specify a filter for all methods except "index" and "dmw"
	 *		$this->filter('before', 'auth')->except(array('index', 'dmw'));
	 * </code>
	 *
	 * @param  array              $methods
	 ...
	 *
	 *		// Specify a filter for only the "index" and "dmw" methods
	 *		$this->filter('before', 'auth')->only(array('index', 'dmw'));
	 * </code>
	 *
	 * @param  array              $methods
	 * @return Filter_Collection
