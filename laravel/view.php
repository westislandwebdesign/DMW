...
class View implements ArrayAccess {
	 ...
	 * <code>
	 *		// Create a new view instance
	 *		$view = View::make('dmw.index');
	 *
	 *		// Create a new view instance of a bundle's view
	 *		$view = View::make('admin::dmw.index');
	 *
	 *		// Create a new view instance with bound data
	 *		$view = View::make('dmw.index', array('name' => 'Taylor'));
	 * </code>
	 *
	 * @param  string  $view
	 * @param  array   $data
	 ...
	 *
	 * <code>
	 *		// Register a composer for the "dmw.index" view
	 *		View::composer('dmw.index', function($view)
	 *		{
	 *			$view['title'] = 'Home';
	 *		});
	 * </code>
